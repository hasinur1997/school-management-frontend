...
- Task 1.5 (`tasks/task-1.5-app-shell.md`): App shell — sidebar + topbar + nav + user menu + branch switcher. (Wire the user menu to `ChangePasswordDialog` and `LogoutButton` from 1.4.)
