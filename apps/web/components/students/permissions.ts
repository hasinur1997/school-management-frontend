 ...
 * `PermissionSeeder`): `student.view` gates the list, and the single
 * `student.update` permission gates every write — profile update, status flip,
 * and photo upload. The profile/enrollments reads are policy-gated server-side
